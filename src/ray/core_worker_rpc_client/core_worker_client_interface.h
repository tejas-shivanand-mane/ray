...
class CoreWorkerClientInterface : public pubsub::SubscriberClientInterface {
 public:
  ...
  virtual void RequestOwnerToCancelTask(
      RequestOwnerToCancelTaskRequest &&request,
      const ClientCallback<RequestOwnerToCancelTaskReply> &callback) = 0;
  ...
  virtual void GossipFuture(
      const rpc::GossipFutureRequest &request,
      const rpc::ClientCallback<rpc::GossipFutureReply> &callback) = 0;
