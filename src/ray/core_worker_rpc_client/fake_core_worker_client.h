...
class FakeCoreWorkerClient : public CoreWorkerClientInterface {
 public:
  ...
  void RequestOwnerToCancelTask(
      RequestOwnerToCancelTaskRequest &&request,
      const ClientCallback<RequestOwnerToCancelTaskReply> &callback) override {}
  ...
  void GossipFuture(
      ...
      const rpc::ClientCallback<rpc::GossipFutureReply> &callback) override {}
